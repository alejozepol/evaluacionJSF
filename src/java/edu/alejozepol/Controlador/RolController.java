...
import edu.alejozepol.Beans.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private edu.alejozepol.Beans.RolFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("RolCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("RolUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("Parametros/Parametros").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("RolDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("Parametros/Parametros").getString("PersistenceErrorOccured"));
        }
    }
