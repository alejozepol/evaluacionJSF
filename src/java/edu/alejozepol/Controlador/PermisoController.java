...
import edu.alejozepol.Beans.PermisoFacade;
...
public class PermisoController implements Serializable {
    ...
    @EJB
    private edu.alejozepol.Beans.PermisoFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("PermisoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("PermisoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("Parametros/Parametros").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("PermisoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("Parametros/Parametros").getString("PersistenceErrorOccured"));
        }
    }
