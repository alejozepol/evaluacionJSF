...
import edu.alejozepol.Beans.TipodocumentoFacade;
...
public class TipodocumentoController implements Serializable {
    ...
    @EJB
    private edu.alejozepol.Beans.TipodocumentoFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("TipodocumentoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("TipodocumentoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("Parametros/Parametros").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("Parametros/Parametros").getString("TipodocumentoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("Parametros/Parametros").getString("PersistenceErrorOccured"));
        }
    }
